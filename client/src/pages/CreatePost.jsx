...
const CreatePost = () => {
    ...
    const generateImg = async () => {
        if (form.prompt) {
            try {
                ...
                const response = await fetch('https://dall-e-ryxz.onrender.com/api/v1/dalle', {
                    method: 'POST',
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.prompt && form.photo) {
            ...
            try {
                const response = await fetch('https://dall-e-ryxz.onrender.com/api/v1/post', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
            ...
            <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-5">
                    ...
                    rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
                        ...
                        {
                            generatingImg && (
                                <div className="absolute inset-0 flex justify-center items-center bg-[rgba(0,0,0,.5)] rounded-lg">
                                    <Loader />
                                </div>
                            )
                        }
                ...
                <div className="mt-5 flex gap-5">
                    <button type="button" onClick={generateImg} className="text-white bg-green-700 
                ...
                <div className="mt-10">
                    ...
                    <button type="submit" className="mt-6 text-white bg-[#6469ff] font-medium
